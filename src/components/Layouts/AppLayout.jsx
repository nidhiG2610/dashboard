...
export default function AppLayout({ children, pageTitle, showMessagePanel = false, showLatestUpdatesPanel = false, showEventsPanel = false, showConversionHistory = false }) {
