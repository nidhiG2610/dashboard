...
const RadioButton = forwardRef(function RadioButton(
    ...
    const defaultControl = `${sizeMap[size]} ${controlBase} border-gray-300 peer-checked:border-blue-600 peer-checked:bg-blue-600`;
    const controlClasses = `${defaultControl} ${controlClassName}`.trim();
    const dotBase = "rounded-full transform transition-transform";
    const dotDefault = `${dotSizeMap[size]} scale-1 peer-checked:scale-100 bg-white`;
